...
function departmentSpecs(): DepartmentSpec[] {
  ...
  return [
    ...
    { id: 'dept-fire', name: t('{0} Fire Brigade', activeCorporation.city), shortName: t('Fire Brigade'), domain: 'emergency', staffCount: 3120, budgetCrore: 890, description: t('Fire prevention, rescue operations, emergency response and fire safety audits.'), scaleBy: 'population' },
