      ...
      {STAGES.map((s, i) => {
        ...
        return (
          <li key={s} className="flex-1">
            <div
              className={cn(
                'flex h-6 items-center justify-center rounded-md border px-1 text-[0.625rem] font-medium',
  ...
  return (
    <PageBody>
      <PageHeader
        ...
        title={t('AI Incidents')}
        description={t('Every AI use case that behaves in a way warranting a record - a grounding failure, a drift signal, a blocked-request pattern - moves through a fixed lifecycle from detection to review. Recording the failures, not only the successes, is what makes the AI layer governed.')}
