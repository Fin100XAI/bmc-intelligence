  ...
  return (
    <PageBody>
      <PageHeader
        ...
        title={t('Scenario Intelligence')}
        description={t('One workspace for the platform\'s three deterministic scenario engines. Every output is a simulation produced by a declared rule model with published driver weights, applied to the current position - it is never a forecast, and it never changes a live municipal record on its own.')}
