  ...
  return (
    <PageBody>
      <PageHeader
        ...
        title={t('{0} Urban Resilience Index', corporation.city)}
        description={t('The city\'s capacity to absorb a shock and keep functioning, scored across the {0} hazards {1} plans against. Every score measures preparedness, not the likelihood of the hazard - a strong flood score does not forecast a mild monsoon.', index.dimensions.length, corporation.city)}
