...
export function EnforcementPage(): React.JSX.Element {
  ...
  usePageMasthead(
    t('Encroachment & Enforcement'),
    t('Notices issued under the MMC Act, 1888 and the MRTP Act, 1966, and what became of each one - one register for a function six other pages could only flag a symptom of.'),
  )
      ...
      <div className="grid grid-cols-1 gap-3 xl:grid-cols-12">
        <div className="flex min-w-0 flex-col gap-3 xl:col-span-8">
          <Card flush>
            <CardHeader
              ...
              description={t('Every notice issued under the MMC Act or the MRTP Act, and what became of it.')}
              actions={
        ...
        <div className="flex min-w-0 flex-col gap-3 xl:col-span-4">
          <Card flush className="flex flex-col">
            <CardHeader icon={<Siren className="h-4 w-4" />} title={t('Recent enforcement drives')} description={t('Time-bound, multi-ward operations - the unit a Removal of Encroachments squad actually works in.')} bordered />
